    ...
    return `
      <div class="al-detail-view">
        <div class="al-detail-header">
          ...
          <div class="al-detail-icon al-detail-star-btn ${goal['A-starred'] ? 'active' : ''}" id="al-goal-star-btn" title="${goal['A-starred'] ? '取消重点标记' : '标记为重点目标'}">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="${goal['A-starred'] ? 'currentColor' : 'none'}" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
          </div>
